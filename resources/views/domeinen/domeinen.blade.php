        ...
        <div class="container px-4 mx-auto">
          <div class="pt-4 bg-white shadow rounded">
            ...
            <div class="p-4 overflow-x-auto">
              ...
              <div class="form__btn">
                <a class="inline-flex items-center py-2 px-3 rounded text-xs text-white bg-indigo-500 hover:bg-indigo-600 rounded" href="/domein/toevoegen">
                <span class="mr-1">
                ...
                <span>Domeinnaam toevoegen</span>
              </a>
              </div>
            </div>
          </div>
