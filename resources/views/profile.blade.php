...
<div class="">
    ...
    <x-menu />
      ...
      @csrf
        ...
        <div class="form--avatar__group w-full md:w-1/2 px-8 mb-4 md:mb-0"><label class="btn--mini  custom-file-upload"><input class="avatar" name="avatar" type="file"/>Afbeelding kiezen</label></div>
