...
<div class="">
    ...
    <x-menu />
      ...
      @csrf
        <div class="form__img w-full md:w-1/3 px-4 mb-4 md:mb-0"><img class="w-20 h-20 p-1 mb-4 mx-auto rounded-full border border-indigo-50" src="{{ asset(' $user->avatar ') }}" alt=""></div>
