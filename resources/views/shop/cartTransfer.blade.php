            ...
            <div class="p-4 overflow-x-auto">
              <table class="table-auto w-full">
                ...
                @csrf
                  ...
                  <tr >
                    <td><div class="mb-6">
                      <label class="block text-sm font-medium mb-2" for="code">Verhuiscode</label>
                      <input class="block w-6/12 px-4 py-3 mb-2 text-sm placeholder-gray-500 bg-white border rounded" type="text" name="code" >
                  </div>
                   </td>
                  </tr>
                </tbody>
