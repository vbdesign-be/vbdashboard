          ...
          <div class="mb-8 p-8 bg-indigo-500 rounded">
            <div class="flex flex-wrap items-center -mx-4">
              <div class="w-full lg:w-2/3 px-4">
                <h2 class="text-3xl text-white font-bold">Opzoek naar een antwoord op je vraag?</h2>
                <p class="text-indigo-50">Hieronder hebben we de meest gestelde vragen voor je opgelijst</p>
              </div>
          ...
          <div class="flex flex-wrap -mx-4">
            <div class="w-full lg:w-3/12 px-4 mb-8 lg:mb-0">
              <div class="p-2 bg-white rounded">
                <ul class="text-sm"><li>
                    <a class="flex p-3 items-center font-medium bg-indigo-50 rounded text-indigo-500" href="/support">
                      <span class="mr-3">
                  ...
                  <li>
                    <a class="flex p-3 items-center font-medium hover:bg-indigo-50 rounded text-gray-500 hover:text-indigo-500" href="support/ask">
                      <span class="mr-3">
                  ...
                  <li>
                    <a class="flex p-3 items-center font-medium hover:bg-indigo-50 rounded text-gray-500 hover:text-indigo-500" href="support/questions">
                      <span class="mr-3">
            ...
            <div class="w-full lg:w-9/12 px-4">
              ...
              <ul><li class="py-5 px-6 mb-3 bg-white shadow rounded">
                  <button class="w-full flex justify-between items-center">
                    <h3 class="text-sm font-bold">What is the most frequently asked question?</h3>
                    <span>
                ...
                <li class="py-5 px-6 mb-3 bg-white shadow rounded">
                  ...
                  <p class="pr-6 mt-3 text-sm text-gray-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis nec urna lacus. Pellentesque in lacus eu est suscipit volutpat eu eget diam. Donec eget justo et diam condimentum bibendum. Donec convallis tellus sem, at lobortis nulla sagittis in. Proin facilisis a enim eget luctus. Sed et maximus libero. Nulla pellentesque imperdiet neque vitae fringilla.</p>
                </li>
                <li class="py-5 px-6 mb-3 bg-white shadow rounded">
                  <button class="w-full flex justify-between items-center">
                    <h3 class="text-sm font-bold">What is the most frequently asked question?</h3>
