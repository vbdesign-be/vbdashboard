...
namespace Vbdesign\Teamleader\Crm;
...
class Company
{
    ...
    public function getBusinessTypes($country){
        ...
        return $this->teamleader->getCall('businessTypes.list?'.http_build_query(['country' => $country]));
    }
    ...
    public function getProvinces($country){
        ...
        return $this->teamleader->getCall('levelTwoAreas.list?'.http_build_query(['country' => $country]));
    }

    public function getProjects($id){
        return $this->teamleader->getCall('projects.list?'.http_build_query(['filter' => ['customer' => ['type' => 'company', 'id' => $id]]]));
    }
